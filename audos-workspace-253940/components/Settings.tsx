          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {email && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium text-[var(--space-text-secondary)] hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors"
            ...
            {statusLoading ? (
              ...
              <div className="space-y-4">
                ...
                {(subscriptionStatus?.status === 'trial' || subscriptionStatus?.status === 'trialing') && (
                  <div className="p-4 bg-[var(--space-surface-accent-soft)] rounded-xl border border-[var(--space-border-default)]">
                    ...
                    <div className="w-full h-2 bg-[var(--space-border-default)] rounded-full overflow-hidden">
                      <div 
                    ...
                    {subscriptionStatus.hasPaymentMethod && (
                      <button
                        ...
                        className="mt-3 flex items-center gap-2 px-3 py-1.5 text-xs font-medium text-[var(--space-text-secondary)] hover:text-[var(--space-text-primary)] hover:bg-white/60 border border-[var(--space-border-default)] rounded-lg transition-colors disabled:opacity-50"
                      >
                        {managingPortal ? (
                ...
                {subscriptionStatus?.status === 'active' && (
                  <div className={`p-4 bg-gradient-to-r ${subscriptionStatus.cancelAtPeriodEnd ? 'from-amber-50 to-orange-50 border-amber-200' : 'from-green-50 to-emerald-50 border-green-200'} rounded-xl border`}>
                    ...
                    <button
                      onClick={handleManageSubscription}
                      disabled={managingPortal}
                      className="mt-3 flex items-center gap-2 px-4 py-2 text-sm font-medium text-[var(--space-text-secondary)] bg-white hover:bg-[var(--space-surface-muted)] border border-[var(--space-border-default)] rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      {managingPortal ? (
                        <>
                          <Loader2 className="w-4 h-4 animate-spin" />
                ...
                {showPaymentCTA && (
                  <div className="space-y-3">
                    ...
                    <button
                      ...
                      className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-[var(--space-brand-primary)] hover:brightness-95 text-[var(--space-text-on-primary)] font-medium rounded-xl transition-all disabled:opacity-50 disabled:cursor-not-allowed"
