...
const baseIconMap: Record<string, ComponentType<any>> = {
  ...
  PiggyBank, TrendingDown, AreaChart, PieChart, Flower2, Scale, Landmark,
};
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex overflow-hidden" style={rootStyle}>
        ...
        <aside
          className={`z-50 flex-shrink-0 flex flex-col min-h-0 overflow-hidden transition-all duration-300 ease-in-out max-md:fixed max-md:inset-y-0 max-md:left-0 max-md:w-72 max-md:max-w-[85vw] ${
