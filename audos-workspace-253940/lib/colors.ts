...
export const tw = {
  ...
  // ---------------------------------------------------------------------------
  // Loanley thread layout: user turns are white bubbles (bordered, right-aligned
  // by the chat view); agent turns sit on the paper off-white with no border.
  message: {
    user: 'bg-[var(--space-surface-card)] border border-[var(--space-border-default)] text-[var(--space-text-primary)]',
    assistant: 'bg-[var(--space-surface-muted)] text-[var(--space-text-primary)]',
  },
  ...
  card: {
    ...
    elevated: 'bg-[var(--space-surface-card)] rounded-2xl shadow-[0_24px_48px_var(--space-shell-shadow),0_2px_6px_var(--space-shell-shadow)]',
    glass: 'bg-[var(--space-surface-panel)] backdrop-blur-md border border-[var(--space-border-default)] rounded-2xl shadow-[0_8px_32px_var(--space-shell-shadow)]',
