...
const toolTerms: Record<string, string> = {
  ...
  // Loanley loan tools
  'loan_math': 'running the real loan maths',
  'loan_benchmark': 'checking typical published ranges',
...
const toolColors: Record<string, string> = {
  ...
  // Loanley loan tools - brand
  'loan_math': 'text-[var(--space-text-brand)]',
  'loan_benchmark': 'text-[var(--space-text-brand)]',
